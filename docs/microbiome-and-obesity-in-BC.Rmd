...
1.  Data preparation and data cleaning for microbiome abundance data
...
plot number of samples across different counts of species over 0.05 abundance

```{r plot to see the distribution of different counts of species, fig.height=12, fig.width=12, warning=FALSE}
...
```{r Top 15 species in obesity and control, warning=FALSE}
library(pals)
...
```{r Beta diversity (1)PCoA plot, warning=FALSE}
...
```{r  Enrichment in species and pathways, warning=FALSE}
#####################species enrichment
...
```{r Conditional logistic regression, warning=FALSE}
########: 
